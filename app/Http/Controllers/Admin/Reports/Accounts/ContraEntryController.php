...
class ContraEntryController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.reports.accounts.contra-entry-print', compact('entries', 'dates'));
    }
    ...
    public function details(Request $request)
    {
        ...
        return view('admin.reports.accounts.contra-entry-details-print', compact('entries', 'dates'));
    }
