...
@section('title', 'Confirm Password - Formonic Design & Construction Ltd')
        ...
        <div class="confirm-card">
            <div class="confirm-header">
                <div class="confirm-logo">
                    <div class="confirm-logo-icon">
                        <i class="fas fa-shield-alt"></i>
                    </div>
                </div>
                <h1 class="confirm-title">Confirm Password</h1>
                <p class="confirm-subtitle">Please confirm your password before continuing</p>
            </div>

            <div class="confirm-form-container">
                <p class="confirm-message">{{ __('Please confirm your password before continuing.') }}</p>
