                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                ...
                                @if(!empty($existingAttachments))
                                    @foreach($existingAttachments as $index => $existingAttachment)
                                                ...
                                                <div class="row g-2 align-items-center">
                                                    ...
                                                    <div class="col-12 col-md">
                                                        <div class="d-flex align-items-center">
                                                            @if(in_array(strtolower(pathinfo($existingAttachment['file_path'], PATHINFO_EXTENSION)), ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                                                <i class="fas fa-image fa-lg text-primary me-2"></i>
                                                            @else
                                                                <i class="fas fa-file-pdf fa-lg text-danger me-2"></i>
                                                            @endif
                                                            <div>
                                                                <h6 class="mb-0 small fw-bold">{{ $existingAttachment['document_name'] }}</h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-auto d-flex justify-content-end justify-content-md-end gap-2">
                                                        <a href="{{ route('admin.documents.show', $existingAttachment['id']) }}" 
                                                           target="_blank" 
                                                        ...
                                                        <button type="button" 
                                                                ...
                                                                wire:click="removeExistingAttachment({{ $existingAttachment['id'] }})"
                                                                title="Remove"
                                    ...
                                    <div class="mt-3 pt-3 border-top">
                                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-2 gap-2">
                                            <h6 class="text-muted mb-0">
                                                <i class="fas fa-archive me-2"></i>Deleted Documents
                                            </h6>
                                            <button type="button" 
                                                        ...
                                                        <div class="row g-2 align-items-center">
                                                            ...
                                                            <div class="col-12 col-md-auto d-flex justify-content-end justify-content-md-end gap-2">
                                                                <button type="button" 
                                                                        ...
                                                                        wire:click="restoreAttachment({{ $deletedAttachment['id'] }})"
                                                                        title="Restore">
                                                                    <i class="fas fa-undo" style="font-size: 0.75rem;"></i>
                                                                </button>
                                                                <button type="button" 
                                                                        class="btn btn-xs btn-outline-danger" 
                                                                        wire:click="permanentlyDeleteAttachment({{ $deletedAttachment['id'] }})"
                                                                        title="Permanently Delete"
                                                                        onclick="return confirm('Are you sure you want to permanently delete this attachment? This action cannot be undone and will delete the file from storage.')">
                                        ...
                                        <div class="card mb-2 border">
                                            <div class="card-body p-2">
                                                <div class="row g-2 align-items-end">
                                                    <div class="col-auto text-center d-none d-md-block" style="width: 30px;">
                                                        <span class="text-muted">{{ count($existingAttachments) + $loop->iteration }}.</span>
                                                    </div>
