        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0 requisition-items-table">
                                    ...
                                    <tfoot class="table-light">
                                        <tr>
                                            <th colspan="3" class="text-end">Total Items: {{ $selectedRequisition->items->count() }}</th>
                                            <th colspan="2" class="text-end">Total Amount:</th>
                                            <th class="text-end"><strong>{{ number_format($selectedRequisition->total_amount, 0) }}</strong></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
                ...
                <div class="modal-footer">
                    ...
                    @if($selectedRequisition && $selectedRequisition->status === 'pending')
                        <button type="button" 
                            ...
                            <span wire:loading.remove wire:target="approveRequisition({{ $selectedRequisition->id }})">
                                <i class="fas fa-check me-1"></i> Approve
                            </span>
                            <span wire:loading wire:target="approveRequisition({{ $selectedRequisition->id }})">
                        ...
                        <button type="button" 
                                ...
                                wire:loading.attr="disabled"
                                data-bs-dismiss="modal">
                            <span wire:loading.remove wire:target="rejectRequisition({{ $selectedRequisition->id }})">
                                <i class="fas fa-times me-1"></i> Reject
                            </span>
                            <span wire:loading wire:target="rejectRequisition({{ $selectedRequisition->id }})">
