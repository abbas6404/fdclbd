...
@section('page-description', 'Add a new user role with permissions')
...
<div class="card shadow">
    ...
    <div class="card-body p-3">
        <form action="{{ route('admin.setup.role.store') }}" method="POST">
            @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    selectAllBtn.addEventListener('click', function() {
        ...
        console.log('Select All clicked - checked', allPermissionCheckboxes.length, 'checkboxes');
    });
    ...
    clearAllBtn.addEventListener('click', function() {
        ...
        console.log('Clear All clicked - unchecked', allPermissionCheckboxes.length, 'checkboxes');
    });
