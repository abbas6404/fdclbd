...
<head>
    ...
    <title>Debit Voucher Report - {{ \Carbon\Carbon::parse($dates['start'])->format('M d, Y') }} to {{ \Carbon\Carbon::parse($dates['end'])->format('M d, Y') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center">No debit vouchers found</td>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
