...
<head>
    ...
    <title>Journal Entry Report - {{ \Carbon\Carbon::parse($dates['start'])->format('M d, Y') }} to {{ \Carbon\Carbon::parse($dates['end'])->format('M d, Y') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right"><strong>{{ number_format($entry->total_amount, 0) }}</strong></td>
            ...
            <tfoot>
                <tr style="background-color: #e9ecef; font-weight: bold;">
                    ...
                    <th class="text-right">
                        {{ number_format($entries->sum('total_amount'), 0) }}
                    </th>
                    <th colspan="2"></th>
                </tr>
            </tfoot>
