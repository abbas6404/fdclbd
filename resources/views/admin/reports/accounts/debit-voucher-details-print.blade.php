...
<head>
    ...
    <title>Debit Voucher Details Report - {{ \Carbon\Carbon::parse($dates['start'])->format('M d, Y') }} to {{ \Carbon\Carbon::parse($dates['end'])->format('M d, Y') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="report-header">
            <div class="company-info">
                ...
                <div class="report-info">
                    <h2>Debit Voucher Details Report</h2>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="5" class="text-center">No debit voucher items found</td>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
