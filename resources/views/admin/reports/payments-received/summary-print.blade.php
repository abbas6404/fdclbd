...
<head>
    ...
    <title>Payments Received Summary Report - {{ \Carbon\Carbon::parse($dates['start'])->format('M d, Y') }} to {{ \Carbon\Carbon::parse($dates['end'])->format('M d, Y') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        <div class="report-header">
            <div class="company-info">
                ...
                <div class="report-info">
                    <h2>Payments Received Summary Report</h2>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center">No payments received found</td>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
                <tr style="background-color: #e9ecef; font-weight: bold;">
                    ...
                    <th class="text-right">
                        {{ number_format($invoices->sum('total_amount'), 0) }}
                    </th>
                    <th></th>
                </tr>
            </tfoot>
