...
<head>
    ...
    <title>Payments Received Details Report - {{ \Carbon\Carbon::parse($dates['start'])->format('M d, Y') }} to {{ \Carbon\Carbon::parse($dates['end'])->format('M d, Y') }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="report-header">
            <div class="company-info">
                ...
                <div class="report-info">
                    <h2>Payments Received Details Report</h2>
            ...
            <tbody>
                @forelse($invoices as $invoice)
                    ...
                    <tr>
                        ...
                        <td class="text-left">{{ $item->paymentSchedule->term_name ?? '-' }}</td>
                ...
                @empty
                <tr>
                    <td colspan="6" class="text-center">No payment items found</td>
                </tr>
                @endforelse
            </tbody>
            <tfoot>
                <tr style="background-color: #e9ecef; font-weight: bold;">
                    ...
                    <th class="text-right">
                        {{ number_format($invoices->sum(function($i) { return $i->items->sum('amount'); }), 0) }}
                    </th>
                    <th></th>
                </tr>
            </tfoot>
